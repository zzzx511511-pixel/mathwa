...
export async function POST(req: NextRequest) {
  ...
  if (field === "all") {
    // Generate description, opinion, tags, and keywords in one call
...
أعطني النتيجة بصيغة JSON فقط، بدون أي نص خارج الـ JSON، على هذا الشكل بالضبط:
{
  ...
  "keywords": ["كلمة1", "كلمة2", "كلمة3", "englishTerm1", "englishTerm2"]
}

تعليمات الوسوم: 3–6 وسوم قصيرة مناسبة للمكان (مثل: عائلي، هادئ، قهوة متخصصة).
تعليمات كلمات البحث: 4–8 كلمات تشمل مرادفات عربية وإنجليزية خصوصاً إذا الاسم أجنبي، لتحسين نتائج البحث.`;
