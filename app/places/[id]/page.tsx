...
export default async function PlaceDetailPage({ params }: { params: { id: string } }) {
  ...
  // is the "hero" branch: its location data is already visible in the top info card.
  // Exclude it from the branches list below to avoid visual duplication.
  // Admins can override per-branch via showInBranchesListEvenIfHero: true.
